...
var Pickit = {
	...
	pickItemNewNotWorkingInDevelopment: function (unit, status, keptLine) {
		...
		return new Promise(function (resolve, reject) {
			...
			require('CharacterCache')('picked').push(item.uniqueId); // Store this item as bot picked, aka unlock these inventory spots
			print('STORING ITEM AS BOT PICKED -- ' + item.uniqueId);
		}).then(function (item) {
			switch (true) {
