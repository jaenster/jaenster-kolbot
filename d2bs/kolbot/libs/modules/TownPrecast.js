...
(function (module, require) {
	...
	TownPrecast.prepare = function() {
		return Precast(Precast.skills.filter(sk => TownPrecast.townCastable.indexOf(sk.skillId) > -1));
	};
	...
	TownPrecast.townCastable = [
		...
		sdk.skills.BoneArmor, sdk.skills.ClayGolem, sdk.skills.BloodGolem, sdk.skills.FireGolem,

		sdk.skills.HolyShield,

		sdk.skills.Raven, sdk.skills.PlaguePoppy, sdk.skills.OakSage, sdk.skills.SummonSpiritWolf,
		...
		sdk.skills.BurstOfSpeed, sdk.skills.Fade, sdk.skills.ShadowWarrior, sdk.skills.BladeShield,
